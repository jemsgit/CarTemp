...
var BluetoothService = /*#__PURE__*/function () {
  function BluetoothService() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, BluetoothService);
    this.deviceId = null;
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(BluetoothService, [{
    key: "getDevices",
    value: function () {
      var _getDevices = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
    ...
    key: "connectToDevice",
    value: function () {
      var _connectToDevice = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2(uuid) {
        var result, _t;
    ...
    key: "disconnect",
    value: function () {
      var _disconnect = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3() {
    ...
    key: "initElm",
    value: function () {
      var _initElm = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee4() {
        var answer;
    ...
    key: "getTemperature",
    value: function () {
      var _getTemperature = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee5() {
        var temp, _t2;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function (_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              console.error('Error getting temperature:', _t2);
              return _context5.abrupt("return", null);
            case 5:
            case "end":
    ...
    key: "sendData",
    value: function () {
      var _sendData = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee6(data) {
    ...
    value: function listen() {
      ...
      if (this.subscriptionActive) {
        this.promisify(bluetoothSerial.unsubscribe.bind(bluetoothSerial)).then(function () {
          _this.subscriptionActive = false;
        })["catch"](function () {
      ...
      bluetoothSerial.subscribe('>', function (data) {
        _this.debug('listen ' + data);
        console.log(data);
        _this.incomingMessage = data;
      }, function (error) {
    ...
    key: "getAnswer",
    value: function () {
      var _getAnswer = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee7() {
        var _this2 = this;
            ...
            case 0:
              return _context7.abrupt("return", new Promise(function (res, rej) {
                ...
                var intId = setInterval(function () {
                  if (_this2.incomingMessage) {
                    res(_this2.incomingMessage);
                    _this2.debug('<<' + _this2.incomingMessage);
                    _this2.incomingMessage = null;
                    clearInterval(intId);
                  } else if (_this2.error) {
                    rej(_this2.error);
                    _this2.debug('<<' + _this2.error);
                    _this2.error = null;
                    clearInterval(intId);
    ...
    key: "setDebug",
    value: function setDebug(callback) {
      this.debug = callback;
    }
  }, {
    key: "promisify",
...
// load the styles
var content = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./styles.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[1].use[1]!./src/styles.css");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(/*! !../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js")["default"])
var update = add("7719be40", content, false, {});
...
/* harmony import */ var _bluetoothService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bluetoothService */ "./src/bluetoothService.js");
  ...
  var app = (0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)({
    ...
    methods: {
      ...
      startMonitoring: function startMonitoring() {
        ...
        intevalId = setInterval(/*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee3() {
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 1;
                return _bluetoothService__WEBPACK_IMPORTED_MODULE_3__["default"].getTemperature();
              case 1:
                _this3.temp = _context3.sent;
              case 2:
              case "end":
                return _context3.stop();
            }
        ...
        return (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee4() {
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _this4.stopMonitoring();
                _context4.next = 1;
                return _bluetoothService__WEBPACK_IMPORTED_MODULE_3__["default"].disconnect();
              case 1:
                _this4.updateLog('disconnected');
                _this4.showList = true;
                _this4.showContent = false;
                _this4.temp = null; // Clear temperature data
                _context4.next = 3;
                break;
              case 2:
                _context4.prev = 2;
                _t3 = _context4["catch"](0);
                _this4.updateLog('err disconnect');
                console.log(_t3);
              case 3:
              case "end":
                return _context4.stop();
      ...
      setBTDebug: function setBTDebug() {
        _bluetoothService__WEBPACK_IMPORTED_MODULE_3__["default"].setDebug(this.updateLog.bind(this));
      },
      ...
      sendCustomCommand: function sendCustomCommand() {
        var _this5 = this;
        return (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee5() {
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context5) {
            while (1) switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 1;
                return _bluetoothService__WEBPACK_IMPORTED_MODULE_3__["default"].sendData(_this5.customCommand);
              case 1:
                _this5.customCommand = '';
              case 2:
              case "end":
                return _context5.stop();
            }
    ...
    computed: {
      temperature: function temperature() {
        if (this.temp) {
          ...
          var temp = parseInt(this.temp, 16);
          return temp - 40 + ' °C';
        }
        return '';
      },
